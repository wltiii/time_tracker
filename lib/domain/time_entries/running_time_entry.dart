...
class RunningTimeEntry {
  ...
  factory RunningTimeEntry.fromJson(Json json) => _$TimeEntryFromJson(json);

  Json toJson() => _$TimeEntryToJson(this);

  void overlapsWith(RunningTimeEntry other) {
